...
public class Demo {
	...
	public static void main(String[] args) {
		...
		try
		{
		db1 = new DbTransaction("jdbc:oracle:thin:@INGNRGPILPHP01:1521:ORCLILP", "aja185core", "aja185core","TBL_BOOKS_1190848");
		
		createMethod(db1);
		
		//HashMap<Integer, Book> hm = TestProcedure.getMapbybookId(db1);
		System.out.println(TestProcedure.getMapbybookId(db1));
